 ...
 * @file            move only.ts
 * @author          Niiju
 * @description     Subcommand group file
 */
...
import { SubcommandGroup_t } from '../../types';
 ...
 */
const description = 'Commands to only move members that fulfill a certain condition.';
...
export default {
    data: { type: 'SUB_COMMAND_GROUP', name, description, options },
    verify,
    execute
} as SubcommandGroup_t;
